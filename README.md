...
This is my fork of the NetHogs program. It has support for csv export. Usage for logging every 60s:
`nethogs -d 60 -z /path/to/.csv`. The csv columes are epoch,local_time,process,pid,user,sent(kB),received(kB)
